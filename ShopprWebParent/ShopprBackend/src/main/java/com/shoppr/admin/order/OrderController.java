...
import com.shoppr.admin.paging.PagingAndSortingParam;
import com.shoppr.admin.security.ShopprUserDetails;

@Controller
public class OrderController {
	private String defaultRedirectURL = "redirect:/orders/page/1?sortField=&sortDir=&keyword=";
	...
	public String listByPage(
			...
			@AuthenticationPrincipal ShopprUserDetails loggedUser) {
