package com.shoppr.admin.customer.controller;
...
import com.shoppr.admin.customer.CustomerService;
...
public class CustomerController {
	private String defaultRedirectURL = "redirect:/customers/page/1?sortField=&sortDir=&keyword=";
	...
	public String updateCustomerEnabledStatus(@PathVariable("id") Integer id,
		...
		return "redirect:/customers/page/" + currentPage + "?sortField=" + sortField + "&sortDir=" + sortDir
				+ "&keyword=" + keyword;
	}	
